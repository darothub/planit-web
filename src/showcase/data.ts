...
export const DEMO_PLANNER_PROFILE_VERIFIED: PlannerProfileResponse = {
  id: 2001,
  userId: 2001,
  email: 'alex.rivera@eventsbyriv.com',
  firstName: 'Alex',
...
export const DEMO_PLANNER_PROFILE_PENDING: PlannerProfileResponse = {
  id: 3005,
  userId: 3005,
...
// ─── Received Inquiries (planner-side, for dashboard overview) ────────────────

export const DEMO_INQUIRIES_RECEIVED: InquiryResponse[] = [
  {
    id: -21,
    status: 'PENDING',
    eventDate: '2026-06-28',
    eventLocation: 'Kensington, London',
    guestCount: 80,
    budgetRange: 'LUXURY',
    listing: { id: 6, title: 'Annual Company Gala Night', coverImageUrl: null },
    client: { id: 1105, firstName: 'Hannah', lastName: 'Morris' },
    planner: { id: 2001, businessName: 'Events by Rivera' },
    lastMessage: 'Hi! We are looking for someone to host our summer gala. Would you be available?',
  ...
  },
  {
    ...
    budgetRange: 'MID_RANGE',
    listing: { id: 5, title: 'Team Building Retreat', coverImageUrl: null },
    client: { id: 1106, firstName: 'Oliver', lastName: 'Hughes' },
    planner: { id: 2001, businessName: 'Events by Rivera' },
    lastMessage: 'We need a full day team-building event for 50 staff members.',
  ...
  },
  {
    ...
    budgetRange: 'LUXURY',
    listing: { id: 4, title: 'Awards Ceremony Night', coverImageUrl: null },
    client: { id: 1107, firstName: 'Clara', lastName: 'Bennett' },
    planner: { id: 2001, businessName: 'Events by Rivera' },
    lastMessage: null,
