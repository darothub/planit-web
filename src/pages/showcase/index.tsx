...
const sections: Section[] = [
  ...
  },
  {
    ...
    screens: [
      ...
      { href: '/showcase/dashboard-onboarding',                  name: 'Onboarding',                    description: 'New planner onboarding checklist with verification banner' },
      { href: '/showcase/dashboard-planner',                    name: 'Overview',                      description: 'Active planner dashboard — redesigned with stat cards, bookings table, inquiry panel' },
  ...
  },
  {
    ...
    screens: [
      ...
      { href: '/showcase/ai-agent',        name: 'AI Agent', description: 'Stream B Phase 1: chat shell, tool-call pills, inline result cards, language switcher (EN/Pidgin/FR/Yoruba), privacy badge — Client + Planner audiences' },
