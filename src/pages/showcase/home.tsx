/**
 * Showcase: Home — Airbnb-style, Planit-branded
 *
 * AirbnbHeader  — Logo | Find Events/Planners tabs (primary colour) | pill search
 * Welcome strip — Planit-specific warm terracotta band with tagline + trust signals
 * AirbnbBody    — Horizontal scrollable category rows on sand bg
 * Discover       — "Find events near you" tabbed city grid (mid-page, not footer)
 * AirbnbFooter  — Charcoal footer with link columns + bottom bar
 *
 * Dev-only. All data from demoData.
 */
...
export default function ShowcaseHome() {
  ...
  return (
    <ShowcaseShell pageName="Home — Planit">
      <Head>
      ...
      {/* ── Welcome strip — Planit-exclusive warm band ───────────────────
          This is what differentiates Planit from a raw Airbnb clone.
          A compact terracotta/sand strip with the brand promise + trust signals.
      ─────────────────────────────────────────────────────────────────── */}
        ...
        {demoCategories.map((category, idx) => (
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-10">
              {/* Primary accent bar above each row — Planit's visual signature */}
      ...
      {/* ── Discover: "Find events near you" ─────────────────────────────
          Moved here from footer — different wording, mid-page placement.
      ─────────────────────────────────────────────────────────────────── */}
